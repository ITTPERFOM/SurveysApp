...
public class HomeActivity extends Activity {
    ...
    //================================================================================
   	...
   	public void Buttons(boolean show){
   		Button btnSelectSurvey = (Button) findViewById(R.id.btnSelectSurvey);
	    Button btnDownloadSurvey = (Button) findViewById(R.id.btnDownloadSurvey);
	    Button btnUploadAnswers = (Button) findViewById(R.id.btnUploadAnswers);
  	  	Button btnCheckIn = (Button) findViewById(R.id.btnCheckIn);
  	  	Button btnStartSurvey = (Button) findViewById(R.id.btnStartSurvey);
		Devices Device = db.GetDevice();
		SelectedSurvey SelectedSurvey = db.GetSelectedSurvey();
